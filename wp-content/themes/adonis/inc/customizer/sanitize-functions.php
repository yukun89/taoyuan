 ...
 */
function adonis_sanitize_select( $input, $setting ) {
 ...
 */
function adonis_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function adonis_sanitize_post( $input ) {
 ...
 */
function adonis_sanitize_image( $image, $setting ) {
    /*
 ...
 * @since Adonis 0.1
 */
function adonis_sanitize_category_list( $input ) {
    if ( '' != $input ) {
        if( in_array( 0, $input ) ) {
            return '0';
        }
 ...
 *                    the setting default.
 */
function adonis_sanitize_number_range( $number, $setting ) {
