 ...
 * @return array Files.
 */
function minimal_grid_import_files() {
    return array(
        array(
            'import_file_name'             =>  esc_html__( 'Default Theme Demo Content', 'minimal-grid' ),
            'local_import_file'            => trailingslashit( get_template_directory() ) . 'demo-data/default/minimal-grid.xml',
            'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'demo-data/default/minimal-grid.wie',
            'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'demo-data/default/minimal-grid.dat',
        )
    );
}
add_filter( 'pt-ocdi/import_files', 'minimal_grid_import_files' );
...
function minimal_grid_after_import_setup() {
...
add_action( 'pt-ocdi/after_import', 'minimal_grid_after_import_setup' );